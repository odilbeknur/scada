...
from .views import Admin_index, Admin_device, CategoryCreateView, baseview, EquipmentCreateView, ProductDetailView, ProductUpdateView, ProductDeleteView, ResponsibleCreateView, ModelCreateView, SearchResultsView

urlpatterns = [
    path('admin-index/', Admin_index, name='admin-index'),
    path('admin-device/', Admin_device, name='admin-device'),
